...
* Fork the ``ivoox_client`` repo into your account.

* Obtain the source by cloning it onto your development machine.

  .. code-block:: console

      $ git clone git@github.com:fernando24164/ivoox_client.git
      $ cd ivoox_client
...
* Create and activate a Python virtual environment for local development. This
  ...
  .. note::
      ...
      (ivoox_client) is used to indicate when the commands
...
* Develop fix or enhancement:
  ...
  * The change should pass static analysis checks (linting and type annotations
    ...
    .. code-block:: console
        ...
        (ivoox_client) $ make check-static-analysis
